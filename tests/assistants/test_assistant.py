...
class TestAssistant:
    ...
    def mock_assistant(self):
        ...
        assistant.type = "test_type"
        assistant.workflow = Mock()
        return assistant
    ...
    def test_execute_success(self, mock_assistant, execution_context, input_messages):
        ...
        with (
            patch("grafi.common.topics.topic.Topic.can_consume", return_value=True),
            patch("grafi.common.topics.topic.Topic.consume", return_value=[event]),
        ):
            # Execute
