...
from grafi.common.topics.topic_base import TopicBase, AGENT_OUTPUT_TOPIC_TYPE
...
class TestAsyncOutputQueue:
    ...
    def mock_topics(self):
        ...
        return [
            MockOutputTopic("output1"),
            MockOutputTopic("output2")
        ]
