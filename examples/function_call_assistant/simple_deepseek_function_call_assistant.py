...
class SimpleDeepseekFunctionCallAssistant(Assistant):
    ...
    class Builder(Assistant.Builder):
        ...
        _assistant: "SimpleDeepseekFunctionCallAssistant"

        def __init__(self) -> None:
            self._assistant = self._init_assistant()

        def _init_assistant(self) -> "SimpleDeepseekFunctionCallAssistant":
            return SimpleDeepseekFunctionCallAssistant.model_construct()
        ...
        def build(self) -> "SimpleDeepseekFunctionCallAssistant":
