...
class OpenKeyTool(LLM):
    ...
    name: str = Field(default="OpenKeyTool")
    type: str = Field(default="OpenKeyTool")
    api_key: Optional[str] = Field(default_factory=lambda: os.getenv("OPENAI_API_KEY"))
    model: str = Field(default="gpt-4o-mini")
    base_url: str = Field(default="https://openkey.cloud/v1")

    @classmethod
    def builder(cls) -> "OpenKeyToolBuilder":
        """
    ...
    def to_stream_messages(self, chunk: ChatCompletionChunk) -> Messages:
        ...
        Args:
            chunk (ChatCompletionChunk): The streaming chunk from the OpenAI API.
